...
\begin{align*}
	...
	D\mbox{ensity} & = \frac{\eta_1 \cdot N_2}{2\eta_2}                       \\
	E\mbox{ffort}  & = DV                                                     \\
...
We will now start the refactoring process using the points that we collected in the previous section
