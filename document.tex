...
\lstset{basicstyle=\fontsize{8}{10}\ttfamily, keywordstyle=\fontsize{8}{10}\bfseries}
\lstset{framesep=5pt}
\lstset{tabsize=4}
\lstset{numbers=left}
...
With the device set-up, we can now move on to testing that is is set up correctly. We can do this by comparing the expected outcome of the corresponding testing harness table made previously, to the actual results of testing.
\begin{table}[H]
	\centering
	\rowcolors{3}{tableShade}{white}
	\begin{tabularx}{\textwidth}{lXXXl}
		...
		2             & Attempting to connect to the Pi via SSH with its IP address and default username                 & We should get a terminal on our desktop which allows us to control the Pi & We are given a terminal and are free do perform any commands as you would on the Pi itself    & YES              \\
		3             &                                                                                                  &                                                                           &                                                                                               &                  \\
		5             &                                                                                                  &                                                                           &                                                                                               &                  \\
		6             &                                                                                                  &                                                                           &                                                                                               &                  \\
		7             &                                                                                                  &                                                                           &                                                                                               &                  \\ \bottomrule
